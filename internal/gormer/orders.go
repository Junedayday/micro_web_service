...
func (order *Order) GetValueByField(field OrderField) interface{} {
	switch field {
	...
	case OrderFieldName:
		return order.Name
	case OrderFieldPrice:
		return order.Price
	case OrderFieldCreateTime:
		return order.CreateTime
	case OrderFieldUpdateTime:
		return order.UpdateTime
	case OrderFieldDeleteStatus:
		return order.DeleteStatus
	}
	return 0
}
